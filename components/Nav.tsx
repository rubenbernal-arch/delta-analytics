    ...
    <>
      <header
        className={`
          ...
          ${scrolled
            ? 'bg-[rgba(7,10,20,0.85)] backdrop-blur-xl border-b border-[var(--line)]'
            : 'bg-transparent'}
        `}
      >
        <div className="max-w-[1140px] mx-auto px-8 py-[1.1rem] flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-[0.92rem] text-muted" aria-label="Navegación principal">
            ...
            <button
              ...
              className="
                text-foreground px-[1.1rem] py-[0.5rem]
                border border-[var(--line-strong)] rounded-full
          ...
          >
            <span
              className={`block h-[2px] bg-foreground rounded transition-transform duration-200
                ${open ? 'translate-y-[7px] rotate-45' : ''}`}
            />
            <span
              className={`block h-[2px] bg-foreground rounded transition-all duration-200
      ...
      <div
        ...
        className={`
          md:hidden fixed inset-0 z-[99]
          bg-[rgba(7,10,20,0.97)] backdrop-blur-2xl
      ...
      >
        ...
        <button
          onClick={() => scrollTo('#contacto')}
          className="
            font-display text-[1rem] font-semibold text-foreground
            px-6 py-3 border border-[var(--line-strong)] rounded-full mt-2
            hover:border-accent transition-all bg-transparent cursor-pointer
          "
        >
          Contacto
        </button>
